...
# rm -rf $SRC/openssl/openssl-1.0.2d && cd $SRC/openssl
...
# rm -rf $SRC/libssh2  #TODO REMOVE WHEN FINISH
...
# 	CFLAGS=$CFLAGS \
# 	CXXFLAGS=$CXXFLAGS \
# 	./configure --prefix=$PREFIX --host=mipsel-openwrt-linux --with-openssl --with-libssl-prefix=$DEST
